...
## 例: make e2e FRONTEND_DIR=../task-canvas/frontend/out E2E_DIR=../task-canvas-e2e E2E_CMD="mvn test"
##   - FRONTEND_DIR: 指定した場合のみ sync-frontend を実行する
##   - E2E_DIR / E2E_CMD: 指定した場合のみ、terraform outputsを環境変数(TF_OUT_*)として
##     エクスポートした上でE2E_DIR内でE2E_CMDを実行する
